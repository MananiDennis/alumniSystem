                ...
                {recentAlumni.length === 0 ? (
                    ...
                    <Box>
                        {recentAlumni.map((alumni) => (
                            <Box key={alumni.id} sx={{
                                p: 2, mb: 2, bgcolor: 'grey.50', borderRadius: 2,
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Box>
                                        ...
                                        <Typography variant="caption" color="text.secondary">
                                            {alumni.location} • Added {new Date(alumni.last_updated).toLocaleDateString()}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ textAlign: 'right' }}>
                                        ...
                                        <Chip
                                            ...
                                            size="small"
                                            color={alumni.confidence_score > 0.7 ? 'success' : 'warning'}
                                        />
                                    </Box>
                                </Box>
                            </Box>
